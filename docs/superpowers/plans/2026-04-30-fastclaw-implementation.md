...
- [ ] **Step 3: （可选）添加 MiniMax M2.7 Provider**
...
- [ ] **Step 1: 查看 FastClaw 工具配置 API**

```bash
curl -s http://localhost:18953/api/tools -b <auth-cookie>
```

- [ ] **Step 2: 配置 Sorftime MCP 连接**
